...
import { listenSteps } from "@/features/landing/lib/data";
...
export function HowToListen() {
  ...
  return (
    <section
      ...
      aria-labelledby="listen-how-heading"
    >
        ...
        <div className="grid gap-8 sm:grid-cols-3">
          {listenSteps.map((step, i) => (
            ...
            >
              ...
              <p className="text-sm leading-relaxed text-wp-muted">{step.body}</p>
            </motion.div>
          ))}
        </div>
      </div>
