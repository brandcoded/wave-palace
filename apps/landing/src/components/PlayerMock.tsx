...
// In dev, use the Next.js proxy to avoid CORS from localhost.
// In production the static export is served from wavepalace.live — same origin as api.wavepalace.live parent domain.
const API_BASE =
