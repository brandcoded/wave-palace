...
| **Pre-Slice 4 add-on** | **Streaming readiness + mux/stream toggle** | **🔲 NEXT** | `streamingActive` + `vrchatFallbackUrl` schema · player switching logic · admin per-channel toggle + bulk toggle + mux refresh controls · no VPS required |
